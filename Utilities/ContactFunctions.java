...
public class ContactFunctions {
	public void createAndAddEmailsContacts(String loggedInEmail , String userName, SinglyLinkedList emailList) {
		...
		if(contactAlreadyExists(loggedInEmail, userName)) {
			return;
		}
	...
	public boolean contactAlreadyExists(String loggedInEmail, String userName)
	{
	...
	public void deleteUser(String loggedInEmail, String userName)
	{
	...
	public void editUser(String loggedInEmail, String oldUserName, String newUserName)
	{
		...
		deleteUser(loggedInEmail, oldUserName);
